            ...
            <motion.div key={item} variants={fadeSlideUp}>
              <Card interactive padding="none" className="overflow-hidden h-full flex flex-col group relative">
                ...
                <div className="h-48 bg-[var(--color-neutral-200)] relative">
                  <img src={`https://picsum.photos/seed/${item + 10}/800/600`} alt="Thumbnail" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                  {item % 2 === 0 && (
                ...
                <div className="p-6 flex flex-col flex-1">
                  <h3 className="text-lg font-bold text-[var(--text-primary)] mb-2 line-clamp-2">Complete Guide to React Server Components</h3>
                  <p className="text-[var(--text-secondary)] text-sm mb-4 flex-1 line-clamp-3">
                    Learn how to leverage React Server Components to build faster, more interactive applications with less client-side JavaScript.
                  </p>
                  <div className="flex items-center justify-between text-sm text-[var(--text-muted)] mt-auto pt-4 border-t border-[var(--color-neutral-100)]">
                    ...
                    <div className="flex items-center font-medium">👁 3.4K</div>
                  </div>
                </div>
              </Card>
            </motion.div>
