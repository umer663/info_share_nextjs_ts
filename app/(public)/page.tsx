...
import { fadeSlideUp, staggerContainer, counterAnimation, fadeIn, scaleIn } from '@/utils/animationVariants';
    ...
    <div className="flex flex-col">
      ...
      <section className="border-y border-[var(--color-neutral-200)] bg-[var(--surface-primary)] py-12">
        <div className="mx-auto max-w-[var(--max-content-width)] px-[var(--space-4)] md:px-[var(--space-8)]">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4 text-center">
            <div className="flex flex-col">
              <span className="text-4xl font-bold text-[var(--color-primary-600)]"><Counter end={500} />+</span>
              <span className="mt-2 text-sm font-medium text-[var(--text-secondary)] uppercase tracking-wider">Posts</span>
            </div>
            <div className="flex flex-col">
              <span className="text-4xl font-bold text-[var(--color-primary-600)]"><Counter end={10} />K+</span>
              <span className="mt-2 text-sm font-medium text-[var(--text-secondary)] uppercase tracking-wider">Views</span>
            </div>
            <div className="flex flex-col">
              <span className="text-4xl font-bold text-[var(--color-primary-600)]"><Counter end={200} />+</span>
              <span className="mt-2 text-sm font-medium text-[var(--text-secondary)] uppercase tracking-wider">Users</span>
            </div>
            <div className="flex flex-col">
              <span className="text-4xl font-bold text-[var(--color-primary-600)]"><Counter end={50} />+</span>
              <span className="mt-2 text-sm font-medium text-[var(--text-secondary)] uppercase tracking-wider">Premium</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[var(--surface-secondary)]">
        <div className="mx-auto max-w-[var(--max-content-width)] px-[var(--space-4)] md:px-[var(--space-8)]">
          ...
          >
            {[1, 2, 3].map((item) => (
              <motion.div key={item} variants={fadeSlideUp}>
                <Card interactive padding="none" className="overflow-hidden h-full flex flex-col">
                  <div className="h-48 bg-[var(--color-neutral-200)] relative">
                    <img src={`https://picsum.photos/seed/${item}/800/600`} alt="Thumbnail" className="w-full h-full object-cover" />
                    {item === 2 && (
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <h3 className="text-xl font-bold text-[var(--text-primary)] mb-2">Understanding Advanced Patterns</h3>
                    ...
                    <div className="flex items-center justify-between text-sm text-[var(--text-muted)] mt-auto">
